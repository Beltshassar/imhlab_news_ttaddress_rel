...
(function () {
         ...
         * Extend ext:news
         */
        $GLOBALS['TYPO3_CONF_VARS']['EXT']['news']['classes']['Domain/Model/News'][] = 'news_ttaddress_rel';

        // $GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['news']['extender'][
        //     \GeorgRinger\News\Domain\Model\News::class
        //     ]['news_ttaddress_rel'] = 'EXT:news-ttaddress-rel/Classes/Domain/Model/News.php';
        ...
        //      ]['news_ttaddress_rel'] = 'EXT:news-ttaddress-rel/Classes/Domain/Model/Address.php';
        ...
        $GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['tt_address']['extender'][\FriendsOfTYPO3\TtAddress\Domain\Model\Address::class]['news_ttaddress_rel'] = 'EXT:news-ttaddress-rel/Classes/Extending/Domain/Model/Address.php';
